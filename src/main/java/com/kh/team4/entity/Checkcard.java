...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "checkcard")
@SequenceGenerator(
        name = "CHECKCARD_SEQ_GENERATOR"  //시퀀스 제너레이터 이름
        , sequenceName = "CHECKCARD_SEQ"  //시퀀스 이름
        , initialValue = 1  //시작값
...
public class Checkcard {
    ...
    @GeneratedValue(  // 기본키를 자동으로 생성해주는 어노테이션
            ...
            , generator = "CHECKCARD_SEQ_GENERATOR" //식별자 생성기를 설정해놓은  USER_SEQ_GEN으로 설정
    )
    private Long cno;
