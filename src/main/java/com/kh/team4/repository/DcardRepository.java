...
public interface DcardRepository extends JpaRepository<Dcard, Long> {
    @Query(value = "SELECT c.airport, c.cloth, c.coffee, c.commi, c.commu, c.conveni, c.cultural, c.delivery, c.edu, c.food, c.foreign, c.gas, c.giftcard, c.hotel, c.medi, c.overseas, c.post, c.publicfee, c.shop, c.stores, c.tran, c.travel " +
            "FROM Dcard c " +
            "WHERE member_mno = ?1 " +
    ...
    List<String> findTop3Columns(Long mno);
